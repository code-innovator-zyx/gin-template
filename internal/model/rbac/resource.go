...
type Resource struct {
	...
	PermissionID uint           `gorm:"index:idx_resource_permission" json:"permission_id" example:"0" description:"所属权限组ID，0表示未分配"`
...
func UpsertResource(path, method string) error {
	return nil
}
